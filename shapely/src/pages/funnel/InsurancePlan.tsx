  ...
  return (
    <>
      ...
      <ButtonComponent
        ...
        className="border-0 left-0 lg:left-[40%] static lg:absolute bottom-[20px] !mt-10"
      />
      <p className="text-xs sm:text-sm !text-[#231F20] static lg:absolute bottom-0 left-[12px] flex gap-2 mt-3 lg:mt-0 items-center text-left">
        <IoIosLock />
