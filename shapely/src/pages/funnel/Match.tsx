...
const Match = () => {
    ...
    return (
        <>
            ...
            <p className="text-[14px] lg:text-[22px] max-w-[50%] mx-auto whitespace-pre-line !text-[#231F20] !mb-5">{localStrings.BASED_ON_ANS}</p>
            ...
            <div className="absolute bottom-3 left-1/2 -translate-x-1/2 w-full">
                ...
                />
                <p className="text-base text-[#231F20] font-medium mt-3">
                    {localStrings.QUESTIONS}{" "}
                    <span className="text-[#FF789A] underline">
                        {localStrings.TALK_TO_COORDINATOR}
                    </span>
                </p>
                <p className="text-xs sm:text-sm !text-[#231F20] flex gap-2 items-center w-max max-sm:mx-auto mt-3 sm:ml-5 lg:mt-0">
                    <IoIosLock />
